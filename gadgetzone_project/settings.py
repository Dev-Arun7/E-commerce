"""
Django settings for gadgetzone_project project.
...
SECRET_KEY = 'django-insecure-2!8os+qk#fvt4o^)(r_s1*6+p=e&y6-#sf=a*eodi#l&gow6l)'
...
WSGI_APPLICATION = 'gadgetzone_project.wsgi.application'
...
# Define the directories from which to gather static files during development
STATICFILES_DIRS = [
...
# https://docs.djangoproject.com/en/4.2/ref/settings/#default# settings.py
